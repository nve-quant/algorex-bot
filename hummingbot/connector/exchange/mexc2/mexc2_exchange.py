...
from hummingbot.connector.exchange.mexc2 import mexc2_constants as CONSTANTS, mexc2_utils, mexc2_web_utils as web_utils
from hummingbot.connector.exchange.mexc2.mexc2_api_order_book_data_source import MexcAPIOrderBookDataSource
from hummingbot.connector.exchange.mexc2.mexc2_api_user_stream_data_source import MexcAPIUserStreamDataSource
from hummingbot.connector.exchange.mexc2.mexc2_auth import MexcAuth
...
class Mexc2Exchange(ExchangePyBase):
    ...
    async def _place_order(self,
        ...
        type_str = Mexc2Exchange.mexc_order_type(order_type)
    ...
    async def _format_trading_rules(self, exchange_info_dict: Dict[str, Any]) -> List[TradingRule]:
        ...
        retval = []
        for rule in filter(mexc2_utils.is_exchange_information_valid, trading_pair_rules):
            try:
    ...
    def _initialize_trading_pair_symbols_from_exchange_info(self, exchange_info: Dict[str, Any]):
        mapping = bidict()
        for symbol_data in filter(mexc2_utils.is_exchange_information_valid, exchange_info["symbols"]):
