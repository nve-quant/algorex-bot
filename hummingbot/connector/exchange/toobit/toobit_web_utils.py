...
import hummingbot.connector.exchange.toobit.toobit_constants as CONSTANTS
...
def public_rest_url(path_url: str, domain: str = CONSTANTS.DEFAULT_DOMAIN) -> str:
    ...
    """
    return urljoin(CONSTANTS.TOOBIT_BASE_URL, path_url)
...
async def get_current_server_time(
    ...
    response = await rest_assistant.execute_request(
        url=public_rest_url(path_url=CONSTANTS.TOOBIT_SERVER_TIMEPATH),
        method=RESTMethod.GET,
        throttler_limit_id=CONSTANTS.TOOBIT_SERVER_TIMEPATH,
    )
