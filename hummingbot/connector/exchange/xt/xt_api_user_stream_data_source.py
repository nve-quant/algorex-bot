...
from hummingbot.connector.exchange.xt.xt_auth import XtcomAuth
...
if TYPE_CHECKING:
    from hummingbot.connector.exchange.xt.xt_exchange import XtcomExchange


class XtcomAPIUserStreamDataSource(UserStreamTrackerDataSource):
    ...
    async def _subscribe_channels(self, websocket_assistant: WSAssistant):
        """
        Subscribes to the user orders and user balance events through the provided websocket connection.
