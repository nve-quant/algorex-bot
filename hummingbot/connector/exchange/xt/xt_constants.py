...
# Public XT API endpoints
SERVER_TIME_API_URL = "https://sapi.xt.com/v4/public/time"
TICKER_INFO_PATH_URL = "/ticker"
TICKER_BOOK_PATH_URL = "/tickers"
MARKETS_INFO_PATH_URL = "/markets"
PING_PATH_URL = "/ping"
SUPPORTED_SYMBOL_PATH_URL = "/symbols"
ORDERBOOK_SNAPSHOT_PATH_URL = "/depth"

# Private XT API endpoints
USER_BALANCES_PATH_URL = "/v4/private/balances"
USER_TRADES_PATH_URL = "/v4/private/trades"
USER_TRADES_SINCE_A_TIMESTAMP_PATH_URL = "/v4/private/trades-since"

CREATE_ORDER_PATH_URL = "/v4/private/order"
CANCEL_ORDER_PATH_URL = "/v4/private/order/cancel"
ORDER_INFO_PATH_URL = "/v4/private/order"

# Ws public methods
WS_METHOD_SUBSCRIBE_ORDERBOOK = "orderbook.subscribe"
WS_METHOD_SUBSCRIBE_TRADES = "trades.subscribe"

# Ws private methods
WS_METHOD_SUBSCRIBE_USER_ORDERS = "user.orders.subscribe"
WS_METHOD_SUBSCRIBE_USER_BALANCE = "user.balances.subscribe"

# Websocket event types
DIFF_EVENT_TYPE = "orderbook.update"
TRADE_EVENT_TYPE = "trades.update"
